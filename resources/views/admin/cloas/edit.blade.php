        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('global.cloa.title_singular') }}
                </div>
                <div class="panel-body">

                    <form action="{{ route("admin.cloas.update", [$cloa->id]) }}" method="POST" enctype="multipart/form-data" id="cloa-edit-record">
                        @csrf
                    <div class="row">
                        <div class="col-md-6">
                        @method('PUT')
                        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                            ...
                            <p class="helper-block">
                                {{ trans('global.cloa.fields.title_helper') }}
                            </p>
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('type') ? 'has-error' : '' }}">
                            ...
                            <input type="text" id="type" name="type" class="form-control" value="{{ old('type', isset($cloa) ? $cloa->type : '') }}">
...
<script>
    $(document).on('submit', "#cloa-edit-record", function(e) {
