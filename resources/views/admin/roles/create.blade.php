        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form action="{{ route("admin.roles.store") }}" method="POST" enctype="multipart/form-data" id="add-new-role">
                        @csrf
...
<script>
    $(document).on('submit', "#add-new-role", function(e) {
        var form = this;
            e.preventDefault();

        $( "#add-new-role input:not(.select2-search__field)" ).each(function(event) {
